...
// @ts-ignore
import rawTemplates from "../../预设模板?raw";
...
try {
  ...
  console.error("Failed to parse preset templates:", e);
}
...
export default function App() {
  ...
  // Preset templates database loaded from the root file "预设模板"
  const PRESET_TEMPLATES = parsedTemplates;
